...
Notes:
    The poem corpus index (public/poems/poems_index.json) is generated by
    scripts/build_poems_index.py and should be committed. Regenerate it
    manually with `python scripts/build_poems_index.py` after adding poems.
"""
